...
function iphone(){
  window.location.href="16promax/iphone-16-pro-max.html";
}

function samsung(){
  window.location.href="s24ultra/samsung-galaxy-s24-ultra.html"
}

function samsungzf(){
  window.location.href="zfold6/samsung-galaxy-z-fold-6.html"
}

function redmagic(){
  window.location.href="9sproplus/nubia-red-magic-9s-pro-plus.html"
}

function sony(){
  window.location.href="1VI/sony-xperia-1-VI.html"
}

function aquos(){
  window.location.href="r8pro/sharp-aquos-r8-pro.html"
}

function oppo(){
  window.location.href="x7ultra/oppo-find-x7-ultra.html"
}

function google(){
  window.location.href="9pro/google-pixel-9-pro-xl.html"
}
